<template>
   <section style="position: relative;" v-loading="loading2" :element-loading-text="loadingText" element-loading-spinner="el-icon-loading" element-loading-background="rgba(255, 255, 255, 0.8)">
      <div class="file-up-down">
         <el-upload class="upload-demo" ref="editTeaPic" :action="portraitUrl"
                    :before-remove="beforeRemove"
                    :on-preview="handlePreview" :on-remove="handleRemove" accept=".xls, .xlsx, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel"
                    :file-list="fileList" list-type="fileList"
                    :before-upload="upBefore" :on-success="upSuccess" :on-error="upFail" :on-change="upChange">
...
<script>
   ...
   export default {
      ...
      created() {
         this.portraitUrl = axios.defaults.baseURL + '/xxb/cooperate/importCooperateExcel';
      },
   };
</script>
